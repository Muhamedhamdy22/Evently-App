...
import 'package:evently_app/providers/fav_page_provider.dart';
...
class FavPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => FavPageProvider()..getFavoriteTasks(),
      builder: (context, child) {
        var provider = Provider.of<FavPageProvider>(context);
        var providerWatch = context.watch<FavPageProvider>();
       return Column(
         children: [
           Expanded(
             child: provider.isLoading
                 ...
                 ? Center(child: Text("No Favorite Tasks"))
                 : ListView.separated(
